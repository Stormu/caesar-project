...
async def add_user(username: Optional[str] = Query(..., min_length=3, max_length=15), 
                   email: Optional[str] = Query(..., regex="[^@\s]+@[^@\s]+\.[^@\s]+"), 
                   password: Optional[str] = Query(..., min_length=12, max_length=50),
...
#Deprecated due to new API endpoints for user editing
"""
